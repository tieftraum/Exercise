...
namespace Exercise.API.Controllers
{
    ...
    public class ManufacturerController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ReadManufacturer>>> GetManufacturers()
        {
            ...
            if (!manufacturers.Any()) return NotFound("manufacturers not found handling error text!");
        ...
        public async Task<ActionResult<ReadManufacturer>> GetManufacturer(int id)
        {
            ...
            if (manufacturer is null) return NotFound("manufacturer not found handling error text!");
        ...
        {
            if (createManufacturer is null) return BadRequest("manufacturer is null handling error text!");
            if (!ModelState.IsValid) return BadRequest("manufacturer validation handling error text!");
